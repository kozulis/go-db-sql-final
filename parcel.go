...
func (s ParcelStore) Get(number int) (Parcel, error) {
	...
	if err != nil {
		return p, fmt.Errorf("error reading data: %w", err)
	}
...
func (s ParcelStore) GetByClient(client int) ([]Parcel, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("error in get by client query: %w", err)
	}
	defer rows.Close()
...
func (s ParcelStore) SetStatus(number int, status string) error {
	...
	if err != nil {
		return fmt.Errorf("error in update status query: %w", err)
	}
...
func (s ParcelStore) SetAddress(number int, address string) error {
	...
	if err != nil {
		return fmt.Errorf("error in update address query: %w", err)
	}
...
func (s ParcelStore) Delete(number int) error {
	...
	if err != nil {
		return fmt.Errorf("error in delete query: %w", err)
	}
